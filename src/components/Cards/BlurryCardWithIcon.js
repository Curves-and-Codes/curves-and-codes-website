...
function BlurryCardWithIcon() {
  return (
    <div className="relative max-w-sm mx-auto rounded-xl border border-cyan-100 border-[0.2px] shadow-lg p-6 md:p-8 text-white transition-transform hover:scale-105 hover:shadow-2xl backdrop-blur-sm bg-gradient-to-br from-[#67e8f9]/10 via-[#ef0163]/5 to-transparent">
      ...
      <p className="text-base md:text-sm text-gray-200 leading-relaxed">
        Monitor your business performance instantly with live dashboards,
        interactive metrics, and predictive insights designed for speed and
        clarity.
      </p>
    </div>
  );
