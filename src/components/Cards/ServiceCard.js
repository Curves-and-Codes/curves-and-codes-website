...
function ServiceCard() {
  return (
    ...
    >
       <div
        className="absolute w-full h-full flex flex-col items-center justify-center px-6 transition-transform duration-700 [backface-visibility:hidden] [transform:rotateY(0deg)] group-hover:[transform:rotateY(180deg)] rounded-xl border border-white/10 backdrop-blur-xl shadow-[var(--shadow-glow)] bg-[var(--card-background)] "
      >
