...
function Home() {
  ...
  const clients = [
    ...
    { name: "Twitter", image: insta },
    { name: "LinkedIn", image: insta },
  ];
  return (
        ...
        <div className="relative z-20 text-white text-center">
          ...
          <div className="p-10 flex flex-wrap justify-center gap-6">
            {clients.map((client, idx) => (
              <ClientCard key={idx} name={client.name} image={client.image} />
            ))}
          </div>
          <div className="m-10">
            <BouncyText
          ...
          <div>
            {/* Project Section */}
            <div className="md:mt-16 flex flex-col lg:flex-row items-center gap-12 w-screen lg:px-10">
              ...
              <div className="w-full lg:w-1/2 text-center lg:text-left">
                ...
                <p className="mt-5 text-sm md:text-base text-slate-300/90 max-w-2xl mx-auto lg:mx-0">
            ...
            <div className="md:mt-16 flex flex-col lg:flex-row-reverse items-center gap-12  w-screen lg:px-10 mb-20">
              <div className="w-full lg:w-1/2 ">
                <ProjectImages />
              </div>
